# -*- coding: utf-8 -*-
"""
Created on Mon Nov 16 15:25:18 2020
...
class Experiment():
    ...
    def __init__(self, M, K, N, fp='ml-100k/u.data', rt='ItemCF'):
        '''
        :params: M, 进行多少次实验
    ...
    def run(self):
        ...
        f.write('Average Result (M={}, K={}, N={}): {}\n'.format(\
                              self.M, self.K, self.N, metrics))
        
if __name__ == '__main__':
    M, N = 8, 10
    # f = open("itemresult.txt","a+")
